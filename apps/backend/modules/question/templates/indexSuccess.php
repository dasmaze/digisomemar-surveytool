...
<div id="sf_admin_container">
  <h1><?php echo __('Question List for survey "' . $surveyTitle . '"', array(), 'messages') ?></h1>
  ...
  <div id="sf_admin_content">
    ...
    <ul class="sf_admin_actions">
      <?php include_partial('question/list_batch_actions', array('helper' => $helper)) ?>
      <?php include_partial('question/list_actions', array('helper' => $helper)) ?>
    </ul>
    </form>
  </div>

  <div id="sf_admin_footer">
    <?php include_partial('question/list_footer', array('pager' => $pager)) ?>
  </div>
</div>
